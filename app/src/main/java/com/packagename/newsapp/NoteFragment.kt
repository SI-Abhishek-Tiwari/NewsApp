...
import com.packagename.newsapp.databinding.FragmentNoteBinding
...
class NoteFragment : Fragment() {
    ...
    private fun setInitialData() {
        val jsonNote = arguments?.getString("note")  //we use arguments in fragment to access ou bundle through key
        if(jsonNote  != null){
            note = Gson().fromJson(jsonNote,NoteResponse::class.java) //here we get string and we converted it in object
            note.let {
